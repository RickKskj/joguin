if (progresso < 1) {
    ...
    Obj_passafase2.sprite_index = computador_consertado;
    Obj_passafase2.animando = false;  // Finalizar a animação
	Obj_passafase2.consertado = true; // Marcar como consertada
	room_goto(room_casa);
}